...
public class StudyService {
    ...
    public boolean createStudy(int userId, String title, String description, String platform, Status status) throws SQLException {
    ...
    public boolean updateStudy(int studyId, String title, String description, String platform, Status status) throws SQLException {
