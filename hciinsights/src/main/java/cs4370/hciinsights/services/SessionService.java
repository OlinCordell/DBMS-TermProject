...
public class SessionService {
    ...
    public boolean createSession(int participantId, int studyId, Timestamp scheduled, String notes, Integer score) throws SQLException {
        final String sql = """
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            if (score == null) pstmt.setNull(5, Types.INTEGER);
            else pstmt.setInt(5, score);
