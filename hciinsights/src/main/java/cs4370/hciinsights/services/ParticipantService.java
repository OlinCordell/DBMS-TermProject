...
public class ParticipantService {
    ...
    public boolean createParticipant(String fname, String lname, Integer age, String occupation, String occupationExp, String email) throws SQLException {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            if (age == null) pstmt.setNull(3, Types.INTEGER);
            else pstmt.setInt(3, age);
